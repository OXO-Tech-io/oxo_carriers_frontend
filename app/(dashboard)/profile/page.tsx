...
import { QUALIFICATION_LEVEL_OPTIONS, type EmployeeEducation, type EmployeeWorkHistory, type ProfileChangeRequest } from '@/types/profile';
import type { ColumnDef } from '@tanstack/react-table';

type ProfileTab = 'personal' | 'education' | 'work-history' | 'pending-changes' | 'employment' | 'documents' | 'settings';
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <ReadOnlyField
                        ...
                        value={formattedDegreeDate()}
                      />
                      <div className="sm:col-span-2">
                        <ReadOnlyField icon={MapPin} label="Address" value={pii?.address || 'Not provided'} />
                      </div>
                    </div>
                  ...
                  {educationLoading ? (
                    ...
                    <div className="space-y-3">
                      {education.map((rec) => (
                        ...
                        >
                          <div>
                            <p className="text-sm font-bold text-[var(--foreground)]">{rec.qualificationTitle}</p>
